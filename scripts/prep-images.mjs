...
const JOBS = [
  ...
  ['custom-funny-superhero-30.png', 'header-quiz.png', 1200, 400],
  ['custom-reaction-penlight-24.png', 'header-review.png', 1200, 400],
  ['custom-angle-sky-40.png', 'header-archive.png', 1200, 400]
];
